...
class PhpClosure {
  ...
  function _getParamList() {
    $params = array();
    $params["js_code"] = $this->source_code;
	...
	//$params['externs_url'] = 'http://closure-compiler.googlecode.com/svn/trunk/contrib/externs/jquery-1.7.js';
	//$params['js_externs_1'] = 'var buildVars = {};';
	//$params['js_externs_2'] = 'var App = {};';
	//$params['js_externs_1'] = 'var App = {}';
	//$params['js_externs_2'] = 'var buildVars = {}';
