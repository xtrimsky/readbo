                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                                ...
                                                <a href="http://readbo.com">
                                            	<img src="http://readbo.com/public/images/mail_header.png" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                            	</a>
                                                    ...
                                                    <tr>
                                                        <td valign="top" width="350">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; <?php echo date('Y'); ?> Readbo.com, All rights reserved.</em>
																<br />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" valign="middle" id="utility">
                                                            <div mc:edit="std_utility">
                                                                &nbsp;<a href="http://readbo.com/unsubscribe">unsubscribe from any emails from Readbo.com</a>&nbsp;
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
